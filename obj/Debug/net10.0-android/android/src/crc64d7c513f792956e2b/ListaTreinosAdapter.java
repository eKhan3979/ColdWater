...
public class ListaTreinosAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ColdWater.Adapters.ListaTreinosAdapter, ColdWater", ListaTreinosAdapter.class, __md_methods);
	}

	public ListaTreinosAdapter ()
	{
		super ();
		if (getClass () == ListaTreinosAdapter.class) {
			mono.android.TypeManager.Activate ("ColdWater.Adapters.ListaTreinosAdapter, ColdWater", "", this, new java.lang.Object[] {  });
		}
	}
